...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void soal21_Click(object sender, EventArgs e)
        {
            s21.ShowDialog();
        }
        ...
        private void soal31_Click(object sender, EventArgs e)
        {
            s31.ShowDialog();
        }
